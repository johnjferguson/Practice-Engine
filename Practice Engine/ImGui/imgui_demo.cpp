    ...
    if (ImGui::TreeNode("Images"))
    {
        ...
        float my_tex_h = (float)io.Fonts->TexHeight;
        {
            ...
            if (ImGui::IsItemHovered())
            {
                ...
                ImGui::Text("Max: (%.2f, %.2f)", (double)region_x + (double)region_sz, (double)region_y + (double)region_sz);
...
static void NodeFont(ImFont* font)
{
    ...
    ImGui::Text("Ascent: %f, Descent: %f, Height: %f", (double)font->Ascent, (double)font->Descent, (double)font->Ascent - (double)font->Descent);
